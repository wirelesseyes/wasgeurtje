const cart_div = document.getElementById(
    "w-commerce-commercecartcontainerwrapper--cartType-rightSidebar"
);
const cart_div_open_link = document.getElementById(
    "w-commerce-commercecartopenlink"
);
const cart_div_close = document.getElementById("cart_close_tag");
var addToCart = document.getElementsByClassName(
    "w-commerce-commerceaddtocartbutton"
);
cart_div_close.onclick = function () {
    cart_div.style.left = "300%";
};
cart_div_open_link.onclick = function () {
    cart_div.style.left = "0%";
};


var closeCartContainer = document.getElementById("w-commerce-commercecartcontainerwrapper--cartType-rightSidebar")
window.onclick= function(e) {
    if(e.target == closeCartContainer) {
        // console.log("clicked outside of the box")
        closeCartContainer.style.left="300%";
    }else{
...
function ready() {
    var removeCartItemsButton = document.getElementsByClassName("btn-remove");
    ...
    var quantityInputs = document.getElementsByClassName("cart_quantity_element");
...
function addItemToCart(title, price, imagesrc, quantityValue) {
    ...
    cartRow.classList.add("w-commerce-commercecartlist", "cart-list");
    ...
    var cartItems = document.getElementsByClassName("cart_items_list")[0];
    ...
    var cartRowsContant = `
        ...
        <div class="w-commerce-commercecartiteminfo div-block">
            ...
            ><div class="btn-remove">Remove</div></a
            >
        </div>
        <input
            type="number"
...
function updateCarttotal() {
    ...
    var cartRows = document.getElementsByClassName("w-commerce-commercecartitem");
    var total = 0;
